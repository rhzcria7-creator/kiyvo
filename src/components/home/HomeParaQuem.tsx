    ...
    <section className="py-16 md:py-24 bg-white dark:bg-[#0B0F1A]">
      <div className="max-w-6xl mx-auto px-5 md:px-8">
        ...
        <div className="text-center mt-10">
          <Link href="/vender" className="inline-flex items-center gap-2 bg-[#0F172A] dark:bg-white text-white dark:text-black rounded-full px-6 py-3 font-bold text-sm hover:scale-105 transition">
