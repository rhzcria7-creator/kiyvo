...
export const metadata: Metadata = {
  title: 'Alternativa à Monetizze 2026: Taxa 8% Máx (sem teto) | KIYVO',
  description: 'Procura alternativa à Monetizze? KIYVO tem taxa 8% + R$0,50 (sem teto), saque PIX em 1 dia útil e 200+ agentes IA.',
  alternates: { canonical: 'https://kiyvo.com.br/alternativa/monetizze' },
  openGraph: { title: 'Alternativa à Monetizze', description: 'KIYVO: 8% máximo (sem teto)', url: 'https://kiyvo.com.br/alternativa/monetizze', type: 'website' },
}
...
export default function Page() {
  return (
    <LongTailPage
      ...
      subtitulo="A Monetizze cobra 9,9% + R$1 sem teto e saques demoram. Na KIYVO você paga no máximo 8% + R$0,50, com sem teto, e recebe em 1 dia útil via PIX."
      ...
      kiyvoDiferenciais={[
        { icone: 'BadgePercent', titulo: '8% + R$0,50 (sem teto)', desc: 'Taxa máxima da KIYVO — uma das menores do Brasil.' },
