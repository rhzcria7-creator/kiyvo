...
export const metadata: Metadata = {
  title: 'Alternativa à Payt em 2026: Taxa 8% Máx (teto R$50) | KIYVO',
  description: `Procurando alternativa à Payt? KIYVO cobra no MÁXIMO 8% + R$0,50 (teto de R$50) por venda. Saque PIX em 1 dia útil, 200+ agentes IA gratuitos, plano free sem mensalidade.`,
  keywords: ['alternativa payt', 'substituta payt', 'melhor que payt', 'plataforma produtos digitais brasil', 'taxa menor que payt'],
  alternates: { canonical: `https://kiyvo.com.br/alternativa/payt` },
  openGraph: {
    title: `Alternativa à Payt com taxa JUSTA | KIYVO`,
    description: 'KIYVO: 8% máximo (teto R$50), saque PIX em 1 dia, 200+ agentes IA.',
    url: `https://kiyvo.com.br/alternativa/payt`,
    type: 'website',
  },
}

const problemas = [
  "Taxas baixas só com volume ALTO de vendas",
  "Pequenos vendedores pagam taxas similares à Hotmart",
  "Saque em 5-10 dias",
  "Poucos recursos extras além de checkout",
  "Marketplace pequeno, pouco tráfego orgânico"
];
const diferenciais = [
  {
    "icone": "BadgePercent",
...
const comparativo = [
  {
    ...
    "concorrente": "Taxas variáveis a partir de 4,99% + R$0,40",
...
export default function AlternativaPage() {
  return (
    <LongTailPage
      titulo={<>Alternativa à <span className="text-brand-500">Payt</span> em 2026 — taxa de 8% no máximo</>}
      subtitulo={`Cansado das taxas e limitações da Payt? Conheça a KIYVO, marketplace brasileiro de produtos digitais com taxa transparente, saque rápido via PIX e 200+ agentes de IA inclusos.`}
      concorrente="Payt"
      concorrenteTaxa="Taxas variáveis a partir de 4,99% + R$0,40"
