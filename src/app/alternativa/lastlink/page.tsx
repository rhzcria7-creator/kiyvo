...
export const metadata: Metadata = {
  title: 'Alternativa à LastLink em 2026: Taxa 8% Máx (sem teto) | KIYVO',
  description: `Procurando alternativa à LastLink? KIYVO cobra no MÁXIMO 8% + R$0,50 (sem teto) por venda. Saque PIX em 1 dia útil, 200+ agentes IA gratuitos, plano free sem mensalidade.`,
