...
export const metadata: Metadata = {
  title: 'Alternativa à Ticto em 2026: Taxa 8% Máx (sem teto) | KIYVO',
  description: `Procurando alternativa à Ticto? KIYVO cobra no MÁXIMO 8% + R$0,50 (sem teto) por venda. Saque PIX em 1 dia útil, 200+ agentes IA gratuitos, plano free sem mensalidade.`,
