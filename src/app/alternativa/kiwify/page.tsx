...
export const metadata: Metadata = {
  ...
  description: 'Kiwify cobra 12% + R$1. KIYVO cobra 8% + R$0,50 com sem teto. Saque PIX em 1 dia útil, 200+ agentes IA.',
...
export default function Page() {
  return (
    <LongTailPage
      ...
      subtitulo="A Kiwify ficou famosa mas a taxa subiu para 12% + R$1 por venda, sem teto. KIYVO cobra 8% + R$0,50 (sem teto) — e tem 200+ agentes IA de venda."
      concorrente="Kiwify"
      ...
      kiyvoDiferenciais={[
        { icone: 'BadgePercent', titulo: '8% + R$0,50 (sem teto)', desc: 'Menos da metade em tickets altos.' },
      ...
      comparativo={[
        { criterio: 'Taxa', concorrente: '12% + R$1', kiyvo: '8% + R$0,50 (sem teto)' },
