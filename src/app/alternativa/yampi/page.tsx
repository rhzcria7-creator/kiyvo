...
export const metadata: Metadata = {
  title: 'Alternativa à Yampi em 2026: Taxa 8% Máx (teto R$50) | KIYVO',
  description: `Procurando alternativa à Yampi? KIYVO cobra no MÁXIMO 8% + R$0,50 (teto de R$50) por venda. Saque PIX em 1 dia útil, 200+ agentes IA gratuitos, plano free sem mensalidade.`,
  keywords: ['alternativa yampi', 'substituta yampi', 'melhor que yampi', 'plataforma produtos digitais brasil', 'taxa menor que yampi'],
  alternates: { canonical: `https://kiyvo.com.br/alternativa/yampi` },
  openGraph: {
    title: `Alternativa à Yampi com taxa JUSTA | KIYVO`,
    description: 'KIYVO: 8% máximo (teto R$50), saque PIX em 1 dia, 200+ agentes IA.',
    url: `https://kiyvo.com.br/alternativa/yampi`,
    type: 'website',
  },
}

const problemas = [
  "Foco em e-commerce FÍSICO (não 100% em infoprodutos)",
  "Recursos limitados para produtos digitais/cursos",
  "Sem sistema avançado de afiliados para infoproduto",
  "Plugins adicionais caros",
  "Sem IA integrada para marketing"
];
const diferenciais = [
  {
    "icone": "BadgePercent",
...
const comparativo = [
  {
    ...
    "concorrente": "2% + R$0,50 por transação (foco e-commerce)",
...
export default function AlternativaPage() {
  return (
    <LongTailPage
      titulo={<>Alternativa à <span className="text-brand-500">Yampi</span> em 2026 — taxa de 8% no máximo</>}
      subtitulo={`Cansado das taxas e limitações da Yampi? Conheça a KIYVO, marketplace brasileiro de produtos digitais com taxa transparente, saque rápido via PIX e 200+ agentes de IA inclusos.`}
      concorrente="Yampi"
      concorrenteTaxa="2% + R$0,50 por transação (foco e-commerce)"
