...
export const metadata: Metadata = {
  ...
  description: 'Microsoft Store cobra 30% de taxa (12% jogos). KIYVO cobra 8% no máximo com sem teto. Venda software, plugins e produtos digitais sem a taxação abusiva.',
...
export default function Page() {
  return (
    <LongTailPage
      ...
      subtitulo="Microsoft e Apple cobram 30% de comissão (12% para jogos). Na KIYVO você paga no máximo 8% + R$0,50 (sem teto) — menos de 1/3 da taxa."
      ...
      kiyvoDiferenciais={[
        { icone: 'BadgePercent', titulo: '8% + R$0,50 (sem teto)', desc: 'Menos de 1/3 da taxa da Microsoft.' },
      ...
      comparativo={[
        { criterio: 'Taxa', concorrente: '30% (12% jogos)', kiyvo: '8% + R$0,50 (sem teto)' },
      ...
      faq={[
        ...
        { pergunta: 'A KIYVO cobra 30%?', resposta: 'Não. Máximo de 8% + R$0,50 com sem teto.' },
