...
export const metadata: Metadata = {
  title: 'Alternativa à Hotmart em 2026: Taxa 8% Máx (sem teto) | KIYVO',
  description: 'Procurando alternativa à Hotmart? KIYVO cobra no MÁXIMO 8% + R$0,50 com sem teto por venda — a metade da Hotmart. Saque PIX em 1 dia útil, 200+ agentes IA, sem letras miúdas.',
  ...
  openGraph: {
    ...
    description: 'KIYVO: 8% máximo (sem teto) — menos da metade da Hotmart. Saque PIX em 1 dia útil.',
...
export default function AlternativaHotmart() {
  return (
    <LongTailPage
      ...
      subtitulo="Cansado de pagar taxas abusivas, saques travados e burocracia na Hotmart? Conheça a KIYVO, marketplace brasileiro de produtos digitais com taxa transparente de até 8% + R$0,50 (sem teto) e saque PIX em 1 dia útil."
      concorrente="Hotmart"
      ...
      kiyvoDiferenciais={[
        { icone: 'BadgePercent', titulo: '8% + R$0,50 (sem teto)', desc: 'Em produtos caros você paga MUITO menos que na Hotmart: 8% + R$0,50, sem teto.' },
      ...
      comparativo={[
        { criterio: 'Taxa sobre venda', concorrente: '10,99% + R$1,00 (sem teto)', kiyvo: '8% + R$0,50 (sem teto)' },
      ...
      faq={[
        ...
        { pergunta: 'Quanto eu pago por mês para usar?', resposta: 'ZERO. Não tem mensalidade, não tem taxa de adesão. Você só paga quando vende: 8% + R$0,50 com sem teto. Planos Plus/Pro/Vendor Pro (opcionais) reduzem a taxa mas não são obrigatórios.' },
        ...
        { pergunta: 'Como funciona o "sem teto"?', resposta: 'Independente do preço do seu produto, a KIYVO nunca vai reter mais do que R$50 em comissão por venda. Em um produto de R$2.000, por exemplo, a Hotmart cobra R$220,80 e a KIYVO cobra apenas R$50. Uma economia de mais de R$170 por venda.' },
      ]}
      cta={{
