'use client'
// Página auto-gerada para o agente Boas-Vindas Email (KIYVO v9.0)
...
export default function Page() {
  ...
  async function gerar() {
    ...
    setResult(null)
    try {
      const res = await fetch('/api/agents/emailboasvindas', {
        method: 'POST',
  ...
  return (
    <AgentShell
      titulo="Boas-Vindas Email"
      tagline="Sequência de onboarding que reduz refunds"
