'use client'
// Página auto-gerada — Venda Cruzada
...
export default function Page() {
  ...
  async function gerar() {
    ...
    try {
      const res = await fetch('/api/agents/vendacruzada', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(input) })
  ...
  return (
    <AgentShell
      titulo="Venda Cruzada" tagline="Recomendações inteligentes"
      icone={<span className="text-2xl">🔗</span>} cor="from-rose-500 to-pink-700"
