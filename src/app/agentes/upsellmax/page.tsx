'use client'
// Página auto-gerada para o agente UpsellMax (KIYVO v9.0)
...
export default function Page() {
  ...
  async function gerar() {
    ...
    setResult(null)
    try {
      const res = await fetch('/api/agents/upsellmax', {
        method: 'POST',
  ...
  return (
    <AgentShell
      titulo="UpsellMax"
      tagline="Ofertas de upsell irresistíveis"
      icone={<span className="text-2xl">{ICON}</span>}
      cor="bg-gradient-to-br from-orange-600 to-red-600"
      onGerar={gerar}
      loading={loading}
