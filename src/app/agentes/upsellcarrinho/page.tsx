'use client'
// Página auto-gerada — Upsell de Carrinho
...
export default function Page() {
  ...
  async function gerar() {
    ...
    try {
      const res = await fetch('/api/agents/upsellcarrinho', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(input) })
  ...
  return (
    <AgentShell
      titulo="Upsell de Carrinho" tagline="Bump + upsell automático"
      icone={<span className="text-2xl">🛒</span>} cor="from-purple-500 to-pink-600"
