'use client'
// Página do agente: Instagram Grid Planner
...
export default function AgentePage() {
  ...
  const formId = 'form-instagramgrid'
  ...
  async function handleGerar(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const res = await fetch('/api/agents/instagramgrid', {
        method: 'POST',
  ...
  return (
    <AgentShell
      titulo="Instagram Grid Planner"
      tagline="Planeje 9/18 posts do Instagram, bio, destaques e calendário de 30 dias."
      icone={icon}
      cor="bg-gradient-to-br from-pink-500 to-fuchsia-600"
