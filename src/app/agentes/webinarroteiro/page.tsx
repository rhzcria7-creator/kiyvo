...
export default function Page() {
  const [input, setInput] = useState<any>({ produtoNome: undefined, preco: undefined, dor: undefined })
  ...
  async function gerar() {
    ...
    try {
      const res = await fetch('/api/agents/webinarroteiro', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(input) })
  ...
  return (
    <AgentShell
      titulo="Roteiro de Webinar" tagline="Webinar de 90 min que converte 8-15%"
