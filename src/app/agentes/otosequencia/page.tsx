...
export default function Page() {
  ...
  async function gerar() {
    ...
    try {
      const res = await fetch('/api/agents/otosequencia', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(input) })
  ...
  return (
    <AgentShell
      titulo="Sequência de OTO/Upsell" tagline="Bump + OTO + Downsell + Sub"
      icone={<span className="text-2xl">🎢</span>} cor="from-pink-500 to-purple-600"
