'use client'
// Página do agente: Auditoria Heatmap CRO
...
export default function AgentePage() {
  ...
  const formId = 'form-hotjarheatmap'
  ...
  async function handleGerar(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const res = await fetch('/api/agents/hotjarheatmap', {
        method: 'POST',
  ...
  return (
    <AgentShell
      titulo="Auditoria Heatmap CRO"
      tagline="Análise heurística de CRO que detecta os problemas que estão matando sua conversão."
      icone={icon}
