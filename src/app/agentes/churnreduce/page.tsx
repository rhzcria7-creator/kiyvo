'use client'
// Página do agente: Reduzir Churn
...
export default function AgentePage() {
  ...
  async function handleGerar(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const res = await fetch('/api/agents/churnreduce', {
        method: 'POST',
  ...
  const icon = <Shield className="w-7 h-7" />

  return (
    <AgentShell
      titulo="Reduzir Churn"
      tagline="Fluxos de email e winback para reduzir cancelamento de assinatura em 15-30%."
      icone={icon}
      cor="bg-gradient-to-br from-emerald-600 to-teal-700"
