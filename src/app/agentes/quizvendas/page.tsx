'use client'
// Página auto-gerada para o agente Quiz de Vendas (KIYVO v9.0)
...
export default function Page() {
  const [input, setInput] = useState<any>({ nicho: '', produtoNome: '' })
  ...
  async function gerar() {
    ...
    setResult(null)
    try {
      const res = await fetch('/api/agents/quizvendas', {
        method: 'POST',
  ...
  return (
    <AgentShell
      titulo="Quiz de Vendas"
      tagline="Quiz que segmenta e converte 3x"
