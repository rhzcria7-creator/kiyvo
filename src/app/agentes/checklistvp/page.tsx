'use client'
// Página auto-gerada para o agente Checklist VP (KIYVO v9.0)
...
export default function Page() {
  ...
  async function gerar() {
    ...
    setResult(null)
    try {
      const res = await fetch('/api/agents/checklistvp', {
        method: 'POST',
  ...
  return (
    <AgentShell
      titulo="Checklist VP"
      tagline="Checklist de página de vendas campeã"
      icone={<span className="text-2xl">{ICON}</span>}
      cor="bg-gradient-to-br from-lime-500 to-lime-700"
      onGerar={gerar}
      loading={loading}
