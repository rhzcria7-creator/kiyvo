'use client'
// Página auto-gerada para o agente Script Bot Resposta (KIYVO v9.0)
...
export default function Page() {
  const [input, setInput] = useState<any>({ produtoNome: '', preco: undefined })
  ...
  async function gerar() {
    ...
    setResult(null)
    try {
      const res = await fetch('/api/agents/scriptbotresposta', {
        method: 'POST',
  ...
  return (
    <AgentShell
      titulo="Script Bot Resposta"
      tagline="Fluxos de atendimento automático"
