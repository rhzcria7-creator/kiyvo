'use client'
// Página do agente: TikTok & Reels Scripts
...
export default function AgentePage() {
  ...
  const formId = 'form-tiktokscripts'
  ...
  async function handleGerar(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const res = await fetch('/api/agents/tiktokscripts', {
        method: 'POST',
  ...
  return (
    <AgentShell
      titulo="TikTok & Reels Scripts"
      tagline="Roteiros virais para TikTok, Reels e Shorts — hook em 3s, CTA que converte."
      icone={icon}
