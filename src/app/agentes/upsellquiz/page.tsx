'use client'
// Página do agente: Quiz de Upsell
...
export default function AgentePage() {
  ...
  async function handleGerar(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const res = await fetch('/api/agents/upsellquiz', {
        method: 'POST',
  ...
  return (
    <AgentShell
      titulo="Quiz de Upsell"
      tagline="Quiz inteligente que aumenta ticket médio em 40% recomendando o produto certo."
      icone={icon}
