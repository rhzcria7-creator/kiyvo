'use client'
// Página do agente: Black Friday Playbook
...
export default function AgentePage() {
  ...
  const formId = 'form-blackfridayplaybook'
  ...
  async function handleGerar(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const res = await fetch('/api/agents/blackfridayplaybook', {
        method: 'POST',
  ...
  return (
    <AgentShell
      ...
      tagline="Estratégia completa de Black Friday em 30 dias — calendário, preços, emails, copy."
      icone={icon}
      cor="bg-gradient-to-br from-red-500 to-orange-600"
