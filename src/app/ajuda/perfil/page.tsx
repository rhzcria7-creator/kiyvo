      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        >
          ...
          <p className="text-lg text-surface-500 dark:text-surface-400 max-w-2xl mx-auto">
            Informações sobre perfil na Kiyvo
          </p>
        </motion.div>
        ...
        <div className="space-y-4">
          <FadeInOnScroll delay={0}>
            <div className="card-base p-6">
              <h3 className="font-display font-bold text-surface-900 dark:text-white mb-2">O que é Perfil?</h3>
              <p className="text-sm text-surface-600 dark:text-surface-400 leading-relaxed">Na Kiyvo, perfil é uma funcionalidade que permite aos usuários interagir com o marketplace de forma segura e eficiente.</p>
            </div>
          </FadeInOnScroll>
          <FadeInOnScroll delay={0.1}>
            <div className="card-base p-6">
              <h3 className="font-display font-bold text-surface-900 dark:text-white mb-2">Como funciona?</h3>
              <p className="text-sm text-surface-600 dark:text-surface-400 leading-relaxed">Acesse a área de perfil através do menu de navegação. Siga as instruções para configurar ou utilizar os recursos disponíveis.</p>
            </div>
          </FadeInOnScroll>
