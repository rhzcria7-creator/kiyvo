    ...
    <PageTransition>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-surface-500 mt-3 max-w-lg mx-auto">Ganhe KD Points em cada compra e venda. Acumule e troque por produtos na plataforma.</p>
        </div>

        {/* Balance */}
        <div className="card-base p-8 text-center mb-8 bg-gradient-to-br from-brand-50 to-brand-100/50 border-brand-200">
          <p className="text-sm text-brand-700 font-display font-semibold mb-1">Seu Saldo de KD Points</p>
        ...
        {/* How to earn */}
        <h2 className="font-display font-bold text-xl text-surface-900 mb-4">Como Ganhar KD Points</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          {[
            ...
            { icon: Clock, title: 'Importante', desc: 'Os KD Points expiram em 6 meses. Utilize antes do vencimento!', color: 'red' },
          ].map((item) => (
        ...
        <div className="card-base p-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-surface-500 text-sm">77 KD Points = R$ 1,00 • Mínimo de resgate: 300 KD Points</p>
          </div>
          <Button>Usar KD Points</Button>
        </div>
      </div>
    </PageTransition>
  )
