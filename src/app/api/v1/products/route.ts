...
// Todos os produtos demo combinados (cursos/marketing da demo1 + keys/assinaturas/GC GGMax)
const ALL_DEMO_PRODUCTS = [...DEMO_PRODUCTS.map((p: any) => ({ ...p, source: 'demo' })), ...GG_PRODUCTS.map((p: any) => ({ ...p, source: 'gg' }))]
