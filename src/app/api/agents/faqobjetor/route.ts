// POST /api/agents/faqobjetor
import { NextRequest, NextResponse } from 'next/server'
import { runFAQObjetor } from '@/lib/agents/faqobjetor'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runFAQObjetor(input, { userId, plan } as any)
