// POST /api/agents/personaplus
import { NextRequest, NextResponse } from 'next/server'
import { personaplus } from '@/lib/agents/v101-boom'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await personaplus(input, { userId, plan } as any)
