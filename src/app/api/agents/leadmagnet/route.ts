// POST /api/agents/leadmagnet
import { NextRequest, NextResponse } from 'next/server'
import { runLeadMagnet } from '@/lib/agents/leadmagnet'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runLeadMagnet(input, { userId, plan } as any)
