// POST /api/agents/faqproduto
import { NextRequest, NextResponse } from 'next/server'
import { faqproduto } from '@/lib/agents/v101-boom'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await faqproduto(input, { userId, plan } as any)
