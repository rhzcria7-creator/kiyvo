// POST /api/agents/metodohero
import { NextRequest, NextResponse } from 'next/server'
import { runMetodoHero } from '@/lib/agents/metodohero'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runMetodoHero(input, { userId, plan } as any)
