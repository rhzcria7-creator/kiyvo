// POST /api/agents/copysniper
import { NextRequest, NextResponse } from 'next/server'
import { runCopyLancamentoSniper } from '@/lib/agents/v9-monetization'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runCopyLancamentoSniper(input, { userId, plan } as any)
