// POST /api/agents/tituloviral
import { NextRequest, NextResponse } from 'next/server'
import { tituloviral } from '@/lib/agents/v101-boom'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await tituloviral(input, { userId, plan } as any)
