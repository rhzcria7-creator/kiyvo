// POST /api/agents/viralloop
import { NextRequest, NextResponse } from 'next/server'
import { runViralLoop } from '@/lib/agents/viralloop'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runViralLoop(input, { userId, plan } as any)
