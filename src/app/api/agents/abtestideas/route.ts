// POST /api/agents/abtestideas
import { NextRequest, NextResponse } from 'next/server'
import { runABTestIdeas } from '@/lib/agents/abtestideas'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runABTestIdeas(input, { userId, plan } as any)
