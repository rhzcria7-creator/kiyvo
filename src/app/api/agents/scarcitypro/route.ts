// POST /api/agents/scarcitypro
import { NextRequest, NextResponse } from 'next/server'
import { runScarcityPro } from '@/lib/agents/scarcitypro'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runScarcityPro(input, { userId, plan } as any)
