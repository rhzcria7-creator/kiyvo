// POST /api/agents/mrrcalc
import { NextRequest, NextResponse } from 'next/server'
import { runReceitaRecorrente } from '@/lib/agents/v9-monetization'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runReceitaRecorrente(input, { userId, plan } as any)
