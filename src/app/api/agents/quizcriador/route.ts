// POST /api/agents/quizcriador
import { NextRequest, NextResponse } from 'next/server'
import { quizcriador } from '@/lib/agents/v101-boom'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await quizcriador(input, { userId, plan } as any)
