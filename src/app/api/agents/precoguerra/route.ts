// POST /api/agents/precoguerra
import { NextRequest, NextResponse } from 'next/server'
import { runPrecoGuerra } from '@/lib/agents/precoguerra'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runPrecoGuerra(input, { userId, plan } as any)
