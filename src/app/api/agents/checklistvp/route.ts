// POST /api/agents/checklistvp
import { NextRequest, NextResponse } from 'next/server'
import { runChecklistPaginaVendas } from '@/lib/agents/checklistvp'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runChecklistPaginaVendas(input, { userId, plan } as any)
