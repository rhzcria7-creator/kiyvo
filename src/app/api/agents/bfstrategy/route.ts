// POST /api/agents/bfstrategy
import { NextRequest, NextResponse } from 'next/server'
import { runBlackFridayEstrategia } from '@/lib/agents/v9-monetization'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runBlackFridayEstrategia(input, { userId, plan } as any)
