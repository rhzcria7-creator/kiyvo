// POST /api/agents/audiencelab
import { NextRequest, NextResponse } from 'next/server'
import { audiencelab } from '@/lib/agents/v101-boom'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await audiencelab(input, { userId, plan } as any)
