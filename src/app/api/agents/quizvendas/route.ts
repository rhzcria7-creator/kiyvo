// POST /api/agents/quizvendas
import { NextRequest, NextResponse } from 'next/server'
import { runQuizVendas } from '@/lib/agents/quizvendas'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runQuizVendas(input, { userId, plan } as any)
