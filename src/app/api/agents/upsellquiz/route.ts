// POST /api/agents/upsellquiz
import { NextRequest, NextResponse } from 'next/server'
import { upsellquiz } from '@/lib/agents/v10-monster'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await upsellquiz(input, { userId, plan } as any)
