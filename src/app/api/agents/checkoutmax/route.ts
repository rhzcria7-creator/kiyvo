// POST /api/agents/checkoutmax
import { NextRequest, NextResponse } from 'next/server'
import { runCheckoutMax } from '@/lib/agents/checkoutmax'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runCheckoutMax(input, { userId, plan } as any)
