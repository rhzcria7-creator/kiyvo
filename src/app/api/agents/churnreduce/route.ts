// POST /api/agents/churnreduce
import { NextRequest, NextResponse } from 'next/server'
import { churnreduce } from '@/lib/agents/v10-monster'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await churnreduce(input, { userId, plan } as any)
