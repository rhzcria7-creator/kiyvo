// POST /api/agents/upsellmax
import { NextRequest, NextResponse } from 'next/server'
import { runUpsellMax } from '@/lib/agents/upsellmax'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runUpsellMax(input, { userId, plan } as any)
