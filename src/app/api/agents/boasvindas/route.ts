// POST /api/agents/boasvindas
import { NextRequest, NextResponse } from 'next/server'
import { runPrimeiraCompra } from '@/lib/agents/v9-monetization'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runPrimeiraCompra(input, { userId, plan } as any)
