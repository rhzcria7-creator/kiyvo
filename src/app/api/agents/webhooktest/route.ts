// POST /api/agents/webhooktest
import { NextRequest, NextResponse } from 'next/server'
import { webhooktest } from '@/lib/agents/v10-monster'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await webhooktest(input, { userId, plan } as any)
