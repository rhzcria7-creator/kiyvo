// POST /api/agents/socialcopy
import { NextRequest, NextResponse } from 'next/server'
import { runSocialCopy } from '@/lib/agents/socialcopy'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await runSocialCopy(input, { userId, plan } as any)
