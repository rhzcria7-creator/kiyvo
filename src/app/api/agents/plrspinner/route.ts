// POST /api/agents/plrspinner
import { NextRequest, NextResponse } from 'next/server'
import { plrspinner } from '@/lib/agents/v10-monster'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await plrspinner(input, { userId, plan } as any)
