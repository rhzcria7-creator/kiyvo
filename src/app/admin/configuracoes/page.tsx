      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        >
          <motion.div
            ...
            className="w-20 h-20 bg-gradient-to-br from-surface-500 to-surface-600 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg"
          >
          ...
          <p className="text-lg text-surface-500 dark:text-surface-400 max-w-2xl mx-auto">
            Configurações da plataforma. Taxas, features e manutenção.
          </p>
        </motion.div>
