        ...
        <div className="card-base p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full btn-primary py-3.5 relative overflow-hidden"
            >
              {loading ? (
          ...
          <div className="mt-6 relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-white text-surface-400">ou continue com</span>
            </div>
          </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="flex items-center justify-center gap-2 px-4 py-2.5 bg-surface-50 border border-surface-200 rounded-xl text-sm font-medium text-surface-700 hover:bg-surface-100 transition-colors"
            >
