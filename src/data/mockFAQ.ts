...
export const mockFAQ: FAQ[] = [
  { id: 'f1', category: 'Playdex', question: 'A Playdex é confiável?', answer: 'Com certeza. Somos o marketplace líder em produtos digitais. Intermediamos todas as transações para garantir que o comprador receba o produto e o vendedor receba o pagamento. Mais de 1 milhão de usuários confiam na plataforma.' },
  { id: 'f2', category: 'Playdex', question: 'O que posso comprar e vender na Playdex?', answer: 'Tudo que é digital! Jogos, contas, keys, software, licenças, cursos online, e-books, templates, gift cards, domínios, APIs, serviços freelance e muito mais. Se é digital, você encontra e vende aqui.' },
